<?php
  ...
  $select1="SELECT * FROM portfolios";
  $portfolios=mysqli_query($db, $select1);
?>
<!doctype html>
                        ...
                        <div class="col-xl-12">
                            <div class="main-menu">
                                <nav class="navbar navbar-expand-lg">
                                    <a href="index.html" class="navbar-brand logo-sticky-none"><img src="style/img/logo/logo.png" alt="Logo"></a>
                                    <a href="index.html" class="navbar-brand s-logo-none"><img src="style/img/logo/s_logo.png" alt="Logo"></a>
            ...
            <div class="extra-info">
                ...
                <div class="side-info mb-30">
                    <div class="contact-list mb-30">
                        ...
                        <p>Mymensingh, Muktagacha, House No:13 Road 02</p>
                    </div>
                    <div class="contact-list mb-30">
                        <h4>Phone Number</h4>
                        <p>+8801940475267</p>
