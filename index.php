            ...
            <div class="row align-items-center">
                <div class="col-xl-7 col-lg-6">
                    <div class="banner-content">
                        ...
                        <h2 class="wow fadeInUp" data-wow-delay="0.4s">I'm Nazmul Islam</h2>
                        <p class="wow fadeInUp" data-wow-delay="0.6s">I'm Nazmul Islam, professional web developer with PHP & Laravel and long time experience in this field​.</p>
                ...
                <div class="col-xl-5 col-lg-6 d-none d-lg-block">
                    <div class="banner-img text-right">
                        <img src="style/img/banner/banner_img.png" alt="">
                    </div>
                </div>
            </div>
        </div>
        <div class="banner-shape"><img src="style/img/shape/dot_circle.png" class="rotateme" alt="img"></div>
    </section>
    <!-- banner-area-end -->
    ...
    <section id="about" class="about-area primary-bg pt-120 pb-120">
        <div class="container">
            <div class="row align-items-center">
                <div class="col-lg-6">
                    <div class="about-img">
                        <img src="style/img/banner/banner_img2.png" title="me-01" alt="me-01">
                    </div>
                </div>
                        ...
                        <div class="col-lg-4 col-md-6 pitem">
                            <div class="speaker-box">
                                <div class="speaker-thumb">
                                    <img src="assets/portfolio/image/<?php echo$portfolio['image']?>" alt="img">
                                </div>
                                <div class="speaker-overlay">
                                    <span><?php echo$portfolio['category']?></span>
                                    <h4><?php echo$portfolio['title']?></h4>
                                    <a href="single.php?id=<?php echo$portfolio['id']?>" class="arrow-btn"><?php echo$portfolio['description']?><span></span></a>
                                </div>
                            </div>
                        </div>                                                                
                        <?php
                    ...
                    <div class="testimonial-active">
                        <div class="single-testimonial text-center">
                            <div class="testi-avatar">
                                <img src="style/img/images/testi_avatar.png" alt="img">
                            </div>
            ...
            <div class="row brand-active">
                <div class="col-xl-2">
                    <div class="single-brand">
                        <img src="style/img/brand/brand_img01.png" alt="img">
                    </div>
                </div>
                <div class="col-xl-2">
                    <div class="single-brand">
                        <img src="style/img/brand/brand_img02.png" alt="img">
                    </div>
                </div>
                <div class="col-xl-2">
                    <div class="single-brand">
                        <img src="style/img/brand/brand_img03.png" alt="img">
                    </div>
                </div>
                <div class="col-xl-2">
                    <div class="single-brand">
                        <img src="style/img/brand/brand_img04.png" alt="img">
                    </div>
                </div>
                <div class="col-xl-2">
                    <div class="single-brand">
                        <img src="style/img/brand/brand_img05.png" alt="img">
                    </div>
                </div>
                <div class="col-xl-2">
                    <div class="single-brand">
