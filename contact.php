...
<body>
  ...
  <header id="header" class="fixed-top d-flex align-items-center ">
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <div class="logo">
        <h1 class="text-light"><a href="index.php"><span>Nazmul</span></a></h1>
      </div>
            ...
            <div class="row">
              <div class="col-md-12">
                <div class="info-box">
                  <i class="bx bx-map"></i>
                  <h3>Our Address</h3>
                  <p>Danmondi 32, Dhaka Bangladesh</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Email Us</h3>
                  <p>nazmulns8989.com<br>contact@example.com</p>
                </div>
              </div>
              <div class="col-md-6">
                <div class="info-box">
                  ...
                  <h3>Call Us</h3>
                  <p>+8801940475267<br>+1 6678 254445 41</p>
                </div>
              </div>
            </div>
          </div>
